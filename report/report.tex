...
public void processJobs(double elapsed) {
    ...
    // Under PS, the total CPU speed is shared equally among all active jobs
...
La libreria \texttt{lib.rng} deriva dalle classi \texttt{Rngs}, \texttt{Rvgs} e \texttt{Rvms} di Park, Miller e collaboratori, adottate nei testi di simulazione per la generazione di numeri pseudo-casuali e variate aleatorie \cite{park-miller,leemis-park-book}. Il generatore di base è un Lehmer multiplicative congruential generator:
\begin{equation}
