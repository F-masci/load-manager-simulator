...
Per quantificare matematicamente questa relazione stocastica, indicando con $x_1, x_2, \dots, x_n$ le $n$ osservazioni consecutive della serie temporale, il formalismo teorico definisce l'autocovarianza campionaria per un lag $j$ generico. Secondo la definizione classica, l'autocovarianza $c_j$ si basa unicamente sugli $n-j$ valori sovrapposti della serie rispetto alla media campionaria globale $\bar{x} = \frac{1}{n}\sum_{i=1}^{n}x_i$, assumendo la forma:
\begin{equation}
