...
\end{lstlisting}
La presenza del termine $\sqrt{n}$ al denominatore della Half-Width è la diretta conseguenza algebrica dell'aver adottato la varianza campionaria corretta $s^2$ \cite{leemis-park}. La varianza campionaria $s^2_{\text{conv}}$ viene definita dividendo convenzionalmente per il numero totale di campioni $n$:
...
Nelle simulazioni a orizzonte infinito, le osservazioni consecutive prodotte da una singola run lunga presentano una forte dipendenza seriale, rendendo invalida l'ipotesi di campionamento indipendente \cite{leemis-park}.
