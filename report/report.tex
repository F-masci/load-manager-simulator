...
L'evoluzione temporale di questa transizione giustifica il tasso di servizio assoluto medio dello Spike Server registrato nei log di simulazione, pari a $4.9760\text{ job/s}$. Il bilancio registra esattamente un'azione di \textit{Speed Up} e una di \textit{Speed Down}, senza oscillazioni ulteriori nella traccia considerata.
