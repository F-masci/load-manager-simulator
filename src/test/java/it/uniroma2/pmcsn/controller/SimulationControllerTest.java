...
public class SimulationControllerTest {
    ...
    public void testVerticalScalingIntegration() {
        ...
        VerticalScaler verticalScaler = controller.getLoadManager().getVerticalScaler();
        assertTrue(verticalScaler instanceof UtilizationThresholdVerticalScaler);
        UtilizationThresholdVerticalScaler utvs =
            (UtilizationThresholdVerticalScaler) verticalScaler;
    ...
    public void testCooldownLogic() {
        ...
        MovingWindowHorizontalScaler scaler =
            new MovingWindowHorizontalScaler(0.1, 0.05, 30.0, 100.0);
